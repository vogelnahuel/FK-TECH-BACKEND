import { InvalidParams } from "./errorsClass";
import { Response } from "express";
/**
 *   Http
 *  @brief clase utilizada para responder al cliente
 */
export class Http {
/**
 *  @brief clase utilizada para responder al cliente
 *  @params status code message data exceptions res
 *  @returns  la respuesta al cliente res.json
*/
  static build(
    status: string,
    code: number,
  ...
  /**
   *  @brief clase utilizada para responder al cliente todo ok
   *  @params data res
   *  @returns  la respuesta al cliente res.json
   */
  static Ok(data: any, res: Response) {
    return Http.build(RESULT.SUCCESS, HTTP_CODES.OK, "OK", data, null, res);
  }
  /**
   *  @brief clase utilizada para responder al cliente  ,No es posible procesar el requerimiento
   *  @params exceptions res
   *  @returns  la respuesta al cliente res.json
   */
  static BadRequest(exceptions: any, res: Response) {
    exceptions ||= [
  ...
  /**
   *  @brief clase utilizada para responder al cliente conflicto con el recurso que se intenta crear
   *  @params exceptions , res
   *  @returns  la respuesta al cliente res.json
   */
  static Conflict(exceptions: any, res: Response) {
  ...
  /**
   *  @brief clase utilizada para responder al cliente,No posee permisos
   *  @params exceptions , res
   *  @returns  la respuesta al cliente res.json
   */
  static Forbidden(exceptions: any, res: Response) {
    exceptions ||= [
  ...
  /**
   *  @brief clase utilizada para responder al cliente,No es posible encontrar el recurso
   *  @params exceptions , res
   *  @returns  la respuesta al cliente res.json
   */
  static NotFound(exceptions: any, res: Response) {
  ...
  /**
   *  @brief clase utilizada para responder al cliente,El metodo utilizado no esta permitido
   *  @params exceptions , res
   *  @returns  la respuesta al cliente res.json
   */
  static MethodNotAllowed(exceptions: any, res: Response) {
  ...
  /**
   *  @brief clase utilizada para responder al cliente,Ocurrio un error interno
   *  @params exceptions , res
   *  @returns  la respuesta al cliente res.json
   */
  static InternalServerError(exceptions: any, res: Response) {
  ...
  /**
   *  @brief clase utilizada para responder al cliente,Requiere autorizacion
   *  @params exceptions , res
   *  @returns  la respuesta al cliente res.json
   */
  static Unauthorized(exceptions: any, res: Response) {
   ...
   *  @returns  la respuesta al cliente res.json
   */
  static NoContent(exceptions: any, res: Response) {
    return Http.build(
      RESULT.SUCCESS,
